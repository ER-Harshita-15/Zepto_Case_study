...
import pandas as pd
from Customer_insights_and_personalization.recommendation.personalized_recommendation.recommender_system import RecommenderSystem
...
def design_promotions_and_discounts(customer_id):
    ...
    recommended_products, product_categories, customer_city, customer_age_group = recommender.recommend_products_for_customer(customer_id)
